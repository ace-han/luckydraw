	...
	var initHtml = function(settings, autoFilled){
		...
		if(autoFilled){
			...
			for(var i=0; i<settings.screenPieceCount; ++i){
				...
				//+ '" style="position:relative; height:' + height + 'px;">Lucky Draw ' + i + '</div>';
				+ '" style="position:relative; height:' + height + 'px;">' + i + '</div>';
				// for temp solution
				//+ '" style="position:relative; height:' + height + 'px;"><div style="line-height: ' + height+ 'px;">Lucky Draw ' + i + '</div></div>';
			}
		} else {
			for(var i=0; i<settings.screenPieceCount; ++i){
				screenPiecesHtml +=  '<div class="' +  settings.screenPieceCssClass 
//				+ '" style="position: relative;">Lucky Draw ' + i + '</div>';
	...
	var initOffsetTops = function(settings){
		...
		// it's simply marginTop = x + (x - (y-x)/2) = 2.5x - .5y = (5x -y)/2
		...
		var marginTop = Math.floor((5 * settings.pieceHeight-settings.screenHeight)/2);
